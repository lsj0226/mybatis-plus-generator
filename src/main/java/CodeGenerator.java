...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setServiceName("%sService");//设置Service包名
         //gc.setSwagger2(true); //实体属性 Swagger2 注解
        gc.setIdType(IdType.ID_WORKER); //设置主键生成类型
...
//        pc.setModuleName(scanner("模块名"));
        ...
        */
        ...
        tableFills.add(new TableFill("creater", FieldFill.INSERT));
        tableFills.add(new TableFill("create_time", FieldFill.INSERT));

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        strategy.setTableFillList(tableFills);
        strategy.setTablePrefix(new String[] { "t_" });// 此处可以修改为您的表前缀        strategy.setNaming(NamingStrategy.underline_to_camel);
